...
3. **Create the spec feature directory**:
   ...
   **Create the directory and spec file**:
   ...
   - If `SPECIFY_FEATURE_DIRECTORY/spec.md` does not exist, copy the resolved `spec-template` file there as the starting point
   - If `SPECIFY_FEATURE_DIRECTORY/spec.md` already exists, preserve it and use it as the editable baseline; never overwrite an existing specification with the template
   ...
   **IMPORTANT**:
   ...
   - The spec directory and file are always created or selected for update by this command, never by the hook
